// Declare global object for user responses
let userResponses = {
  gender: "",
  birthDate: "",
  allergy: "",
...
function genderNext() {
  $(".chooseGenderM").click(() => {
    ...
    userResponses.gender = "Мужчина"; // Save response
  ...
  $(".chooseGenderW").click(() => {
    ...
    userResponses.gender = "Женщина"; // Save response
...
function appAge() {
  ...
  let data = setInterval(() => {
    ...
    if (day != "" && month != "" && year != "") {
      ...
      myMassange(birthDate);

      userResponses.birthDate = birthDate; // Save response
...
function YsNo() {
  ...
  $("#yeas").click(() => {
    ...
    userResponses.allergy = "Да"; // Save response
  ...
  $("#no").click(() => {
    ...
    userResponses.allergy = "Нет"; // Save response
...
function symptoms() {
  ...
  $(".chat-content-list").on("click", "#yeas", () => {
    $(".chat-content-buttons-gender").css("display", "none");
    myMassange("Да");

    userResponses.symptoms = "Да"; // Save response
  ...
  $(".chat-content-list").on("click", "#no", () => {
    $(".chat-content-buttons-gender").css("display", "none");
    myMassange("Нет");

    userResponses.symptoms = "Нет"; // Save response
...
const formEl = document.querySelector("#order_form");
const inputEl = document.querySelectorAll(".input-roulette");
...
let serResponses = {
  ...
  birthDate: userResponses.birthDate,
  allergy: userResponses.allergy,
  symptoms: userResponses.symptoms,
};

function printFormDataAndUserResponses() {
  let formData = {
...
$(".submit-roulette").click(() => {
  printFormDataAndUserResponses();
});
